...
class Timer extends PureComponent {
  ...
  componentDidUpdate() {
    const changeColor = (color) => this.timer.current.style.color = color
    changeColor('#FFFFFF')
    setTimeout(() => changeColor('#000000'), 500)
  }

  // the behavior offered by the method below is provided by PureComponent
